  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-16 md:pt-24 md:pb-20 text-center">
        <h1 className="font-display font-extrabold text-[40px] leading-[1.08] md:text-[58px] md:leading-[1.06] tracking-tight text-ink max-w-3xl mx-auto">
          Turn WhatsApp conversations into customers.
        </h1>
        <p className="mt-6 text-lg text-sub leading-relaxed max-w-xl mx-auto">
          Flume captures leads from your Meta and TikTok campaigns, scores them, helps you qualify them, and gives you everything you need to close the deal — right inside WhatsApp.
        </p>
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {[
            ["01", "Connect", "Link your WhatsApp Business number, Facebook and TikTok ad accounts in a few taps."],
            ["02", "Capture", "Every reply to your campaigns lands in one inbox, tagged with its source automatically."],
            ["03", "Qualify", "Flume asks the questions you'd ask, scores the answers, and tells you who's ready to buy."],
            ["04", "Convert", "Suggested replies and a clear next step get you from hello to a won deal faster."],
          ].map(([num, title, body]) => (
            <div key={title}>
              <div className="text-sm text-faint mb-3">{num}</div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-bg border border-border rounded-feature p-6">
            <div className="flex items-center justify-between mb-4 gap-3">
              ...
              <span className="text-xs font-medium text-green-dark bg-green-light px-2.5 py-1 rounded-pill shrink-0">Score 92 · High</span>
            </div>
            <div className="space-y-3 text-sm">
              {[
                ["Intent", "Strong"],
                ["Reason", "Event purchase, fixed date"],
                ["Budget signal", "Mentioned"],
                ["Source", "Facebook"],
              ].map(([k, v]) => (
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="max-w-md mx-auto bg-surface border border-border rounded-feature shadow-card p-6">
          <div className="bg-muted rounded-card p-4 mb-4">
            ...
            <div className="text-sm text-ink">How much for 20 chairs, delivered Saturday?</div>
          </div>
          ...
          <div className="border border-border rounded-card p-4 text-sm text-ink leading-relaxed">
            Hi Adebayo, thanks for reaching out. We can help with the 20 chairs for your event next Saturday.
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border border-border rounded-feature p-8 md:p-10 bg-bg flex flex-col">
              <div className="text-sm font-medium text-sub mb-6">Free</div>
            ...
            <div className="border-2 border-green rounded-feature p-8 md:p-10 bg-bg flex flex-col">
              <div className="text-sm font-medium text-sub mb-6">Pro Monthly</div>
              <div className="font-display font-bold text-4xl text-ink leading-none">₦15,000</div>
            ...
            <div className="border border-border rounded-feature p-8 md:p-10 bg-bg flex flex-col">
              <div className="text-sm font-medium text-sub mb-6">Pro Yearly</div>
              <div className="font-display font-bold text-4xl text-ink leading-none">₦150,000</div>
      ...
      <section id="faq" className="max-w-3xl mx-auto px-6 py-24">
        ...
        <div className="divide-y divide-border border-t border-b border-border">
          {[
            ["Do I need the WhatsApp Business API?", "No. Flume connects to your existing WhatsApp Business number and handles the API setup for you during onboarding."],
            ["Can I cancel anytime?", "Yes. Pro plans are month-to-month or annual with no lock-in."],
            ["Is my customer data secure?", "Conversations are encrypted in transit and at rest."],
          ].map(([q, a]) => (
            <details key={q} className="group py-5">
              <summary className="flex items-center justify-between cursor-pointer text-ink font-medium gap-4">
                {q}
                <span className="text-faint text-xl shrink-0">+</span>
              </summary>
              <p className="mt-3 text-sm text-sub leading-relaxed">{a}</p>
            </details>
          ))}
        </div>
      </section>
